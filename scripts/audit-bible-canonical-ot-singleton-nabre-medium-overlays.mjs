...
const mappings = [
  {
    "book": "2chronicles",
    "activePath": "data/bible/OT/2chronicles.json",
    "sourcePath": "data/bible/translations/nabre-internal-source-lane/source/generated_data/books/2Chronicles.json",
    "source": "2:17",
    "active": "2:18"
  },
  {
  ...
  {
    "book": "ecclesiastes",
    "activePath": "data/bible/OT/ecclesiastes.json",
    "sourcePath": "data/bible/translations/nabre-internal-source-lane/source/generated_data/books/Ecclesiastes.json",
    "source": "5:19",
    "active": "5:20"
  },
  {
...
const report = {
  audit: 'canonical-ot-singleton-nabre-medium-overlays',
...
if (failures.length) {
  ...
  console.log('NEXT: Review singleton NABRE medium overlay failures.');
} else {
  console.log('ALL PASSED');
  console.log('NEXT: Singleton medium overlays are guarded; canonical OT remains untrusted.');
}
